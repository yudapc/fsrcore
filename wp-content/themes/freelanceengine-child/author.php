					...
					<div class="profile-<?php echo $class_name ?>-info-wrap">
						<div class="profile-<?php echo $class_name ?>-info">
							...
							<div class="<?php echo $class_name ?>-info-content">
								<div class="<?php echo $class_name ?>-rating">
									<?php if (fre_share_role() || ae_user_role($author_id) == FREELANCER) { ?>
										...
										<?php if(ae_user_role($current_user->ID) == EMPLOYER || ae_user_role($current_user->ID) == 'administrator'): ?>
									...
									<?php } else { ?>
										...
										<span> <?php printf(__('hired %s freelancers', ET_DOMAIN), intval($hire_freelancer)); ?></span>
									<?php } ?>
							...
							if ($author_available == 'on' || $author_available == '') {
								...
								if ((ae_user_role($user_ID) == EMPLOYER  || current_user_can('manage_options')) && $user_ID != $author_id) { ?>
									<a href="#" data-toggle="modal" class="fre-normal-btn primary-bg-color <?php if (is_user_logged_in()) {
																																														echo 'invite-open';
																																													} else {
																																														echo 'login-btn';
								...
								if ($show_btn) { ?>
									<a href="#" data-toggle="modal" class="fre-normal-btn contact-me" data-user="<?php echo $convert->post_author ?>">
