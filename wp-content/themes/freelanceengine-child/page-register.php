		...
		<div class="container">
			<div class="fre-authen-wrapper">
				<div class="fre-register-default">
					<h2><?php _e('Register', ET_DOMAIN)?></h2>
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="register-freelancer">
									<h3><?php _e('Remote Talent', ET_DOMAIN);?></h3>
									<p><?php _e('Create your profile and find your ideal remote job.', ET_DOMAIN);?></p>
			...
			<div class="container">
				<div class="fre-authen-wrapper">
					<div class="fre-authen-register">
						...
						<?php }else{ ?>
								<h2><?php _e('Sign up as Remote Talent', ET_DOMAIN);?></h2>
						<?php } ?>
						<form role="form" id="signup_form">
							...
							<div class="fre-input-field">
								<?php
					                ...
					                $url_tos = '<a href="'.et_get_page_link('tos').'" class="secondary-color" rel="noopener noreferrer" target="_Blank">'.__('Terms of Use and Privacy policy', ET_DOMAIN).'</a>';
					                if($tos) {
					                	echo "<p>";
