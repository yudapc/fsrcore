                            ...
                            <div class="fre-project-list-wrap">
                                <div class="fre-project-result-sort">
                                    <div class="row">
										...
										$plural      = sprintf( __( '%s jobs found', ET_DOMAIN ), $found_posts );
										$singular    = sprintf( __( '%s job found', ET_DOMAIN ), $found_posts );
										$not_found   = sprintf( __( 'There are no jobs posted on this site!', ET_DOMAIN ), $found_posts );
										?>
											...
											<?php if ( $query_post >= 1 ) { ?>
                                                <div class="fre-project-sort">
                                                    <select class="fre-chosen-single sort-order" id="project_orderby"
                                                            name="orderby">
                                                        <option value="date"><?php _e( 'Latest Jobs', ET_DOMAIN ); ?></option>
