		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">
					<?php _e("Interview acceptance confirmation", ET_DOMAIN) ?>
				</h4>
			</div>
...
<script type="text/template" id="bid-info-template">
	<p>
		<?php _e( 'You are about to accept this interview for' , ET_DOMAIN ); ?> <strong>{{=budget}}</strong>
		<?php //Remove Payment System ?>
	...
	<div class="fre-form-btn">
		<button type="submit" class="fre-normal-btn">
            <?php _e('Accept Interview', ET_DOMAIN) ?>
        </button>
