        ...
        <div class="modal-content">
            <div class="modal-header">
				...
				<?php if ( ! ( ae_get_option( 'invited_to_bid' ) && ! fre_check_invited( $user_ID, $post->ID ) ) ) { ?>
                    <h4 class="modal-title"><?php _e( 'Job Interest', ET_DOMAIN ); ?></h4>
				<?php } else { ?>
            ...
            <div class="modal-body">
				...
				if ( empty( $profile_id ) or ! is_numeric( $profile_id ) ) { ?>
                    <div class="not-bid-form fre-modal-form">
                        <h2><?php _e( 'You have to update your profile before expressing interest on this project!', ET_DOMAIN ); ?></h2>
                        ...
                        <p><?php _e( 'You can express interest on any job. Please click the Update button below to update your profile.', ET_DOMAIN ); ?></p>
