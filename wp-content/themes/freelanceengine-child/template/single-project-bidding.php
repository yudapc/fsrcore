            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <div class="col-free-bidding"><?php printf( __( 'APPLICANTS (%s)', ET_DOMAIN ), $bid_query->found_posts ); ?></div>
                    </div>
                    <div class="col-md-4 hidden-sm hidden-xs">
                        <div class="col-free-reputation"><?php _e( 'EXPERIENCE', ET_DOMAIN ); ?></div>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-3 hidden-xs">
                <div class="col-free-bid"><?php _e( 'HOURLY RATE', ET_DOMAIN ); ?></div>
            </div>
        </div>
    </div>
