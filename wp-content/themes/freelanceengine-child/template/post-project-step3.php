        ...
        <form class="post" role="form">
            <div class="step-post-project" id="fre-post-project">
                ...
                <div class="fre-input-field">
                    <label class="fre-field-title" for="project_category"><?php _e('Job categories', ET_DOMAIN);?></label>
                    <?php
                        $cate_arr = array();
                ...
                <div class="fre-input-field">
                    <label class="fre-field-title" for="fre-project-title"><?php _e('Your job title', ET_DOMAIN);?></label>
