              ...
              <div class="row">
                  <div class="col-md-4">
                      <div class="fre-input-field">
                          ...
                          <input class="keyword search" id="s" type="text" name="s" placeholder="<?php _e('Search talent by keyword', ET_DOMAIN);?>">
                      </div>
                  </div>
                  <div class="col-md-4">
                      <div class="fre-input-field dropdown">
                          <label for="skills" class="fre-field-title"><?php _e('Skills', ET_DOMAIN);?></label>
                          <input id="skills" class="dropdown-toggle fre-skill-field" type="text" placeholder="<?php _e ('Search talent by skills', ET_DOMAIN ); ?>" data-toggle="dropdown" readonly>
