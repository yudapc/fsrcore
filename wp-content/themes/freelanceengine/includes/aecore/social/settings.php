...
function ae_social_login_settings($pages) {
    ...
    $sections[] = array(
        ...
        'groups' => array(
             ...
             array(
                'args' => array(
                    'title' => __("Seting Social Login API", ET_DOMAIN) ,
                    'id' => 'social-api',
                    'class' => '',
                    'desc' => __("Follow the <a href='http://guides.enginethemes.com/knowledge-base/fre-setup-the-social-login-feature/' target='_blank'> tutorial post</a> to setup your social login API.<br /> <p> &nbsp</p>", ET_DOMAIN)
                ) ,
