...
function ae_get_currency_checkout($order  = array()){

	$df_currency =  ET_Payment::get_currency();

	$currency_checkout =  apply_filters('set_currency_checkout', $df_currency, $order);

	return $currency_checkout;
}