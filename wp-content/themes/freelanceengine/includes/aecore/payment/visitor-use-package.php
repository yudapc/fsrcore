        ...
        if ($ad_id) {
            ...
            if (!is_wp_error($ad)) {
                ...
                if( !is_acti_fre_membership() ){
                    ...
                    $available = apply_filters('check_use_package',$available, $ad);
                }
                ...
                if ($available) {
                     ...
                     */
                    et_track_payment('do_checkout: update quanlity of package after submit post');
                    if( ! is_acti_fre_membership() ){
                        AE_Package::update_package_data($ad->et_payment_package, $ad->post_author);
                    } else {
                        et_track_payment('update qunality via membership');
                        do_action('fre_update_pack_quantity',$ad);
                    }
