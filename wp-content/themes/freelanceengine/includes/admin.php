	...
	function admin_setup() {
        ...
        */
		...
		if( ae_get_option('pay_to_bid',false) ){
			...
			$freelancer_fields[]=	array(
				'args'   => array(
					'title' => __( "Number Bid Free Per Month", ET_DOMAIN ),
					'id'    => 'fre_free_bid',
					'class' => 'fre_free_bid',
					'desc'  => __( "Free bid per month for freelancer.", ET_DOMAIN ),
				),
				'fields' => array(
					array(
						'id'    => 'fre_free_bid',
		...
		$payment_fields[] = array(
			'args'   => array(
				...
				'id'    => 'Paypal',
				'class' => 'payment-gateway',
				'desc'  => __( "Enabling this will allow your users to pay via PayPal. Use a business account and enable <a href='http://forum.enginethemes.com/thread/paypal-standard/' target='_blank'>IPN</a>", ET_DOMAIN ),
