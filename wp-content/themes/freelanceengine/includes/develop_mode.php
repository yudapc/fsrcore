<?php
function fre_generator_project_form(){
    global $user_ID;
    $step = 3;
    $class_active = '';
    ...
    $post_title = 'Project title auto generate post at '.$time;
    $post_content = 'Project content auto generate at '.$time;
    $et_budget  = rand(10,100);
?>
        ...
        <form class="post" role="form">
            <div class="step-post-project" id="fre-post-project">
                ...
                <div class="fre-input-field">
                    ...
                    <input class="input-item text-field" id="fre-project-title" type="text" name="post_title" value="<?php echo $post_title;?>">
                </div>
                <div class="fre-input-field">
                ...
                <div class="fre-input-field">
                    ...
                    <div class="fre-project-budget">
                        <input id="project-budget" step="5" required type="number" class="input-item text-field is_number numberVal" name="et_budget" min="1" value="<?php echo $et_budget;?>">
