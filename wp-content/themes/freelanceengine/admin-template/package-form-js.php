		...
		<div class="form payment-plan">
			...
			<div class="form-item f-left-all clearfix">
				...
				<div class="width33p">
					...
					<input value="{{= et_duration }}" class="bg-grey-input width50p not-empty is-number required number" type="text" name="et_duration" /><?php _e('days', ET_DOMAIN);?>

				</div>
				<div class="width33p">
				<?php
					$txt =  __("Number of project can post.",ET_DOMAIN);
					if(is_acti_fre_membership()){
						$txt =  __("Number of project can post per month.",ET_DOMAIN);
					}
				?>
