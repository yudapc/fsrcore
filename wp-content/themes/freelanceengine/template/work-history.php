...
<div class="info-project-items-employer">
    <div class="inner">
        ...
        <div class="project-status-filter">
            <a class="show-bidden click-type bid-show" data-name='bidden' data-type='show'><?php _e('View open jobs', ET_DOMAIN)?></a>
            <a class="show-bidden click-type bid-hide" data-name='bidden' data-type='hide' style="display:none;"><?php _e('View all jobs', ET_DOMAIN)?></a>
        </div>-->
