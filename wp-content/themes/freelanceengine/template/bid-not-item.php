	...
	<?php
		...
		if($project->post_status == 'publish' ){
		 	if( (int) $project->post_author == $user_ID || $role != FREELANCER ){?>
		 		<div class="col-md-12">
		 			<p><?php _e('Talent who apply for the job will be listed here.',ET_DOMAIN);?></p>
				</div>
			...
			<?php } else if( $role == 'freelancer' || !$user_ID ) { ?>
				<div class="col-md-12">
					<p>
						<?php _e('Talent who apply for the job will be listed here.',ET_DOMAIN);?>
					</p>
				</div>
			...
			$status = 	array(	'pending' => __('This job is pending.', ET_DOMAIN),
								'archive' => __('This job has been archived.',ET_DOMAIN) ,
								'reject'  => __('This job has been rejected.',ET_DOMAIN) );
