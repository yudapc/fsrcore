<?php
	...
	global $is_post_free, $pay_to_bid, $show_bid_pack, $show_project_pack;
		...
		<div class="col-md-10">
			<div class="row fre-service-package-list">
				<?php
										...
										<div class="service-price">
											<?php
												if($package->et_price > 0) {
													echo "<h2>";echo fre_price_format($package->et_price, 'sup');echo "</h2> ";
					...
					} else if( $show_bid_pack ) { // if freelancer similar - only show list bid package if pay_to_bid = 1
	    						...
	    						<div class="col-md-4 col-sm-6">
									<div class="fre-service-pricing">
										<div class="service-price">
											<?php
												if($plan->et_price > 0) {
													echo "<h2>"; echo fre_price_format($plan->et_price,'sup');echo "</h2> ";
		                        				}else{
		                        					echo "<h2>";_e("FREE", ET_DOMAIN);echo "</h2> ";
		                        				}
											?>
